...
module.exports = {
  ...
  INBOUND_MESSAGE_METRICS_FLUSH_SECONDS: process.env.INBOUND_MESSAGE_METRICS_FLUSH_SECONDS || 60,
  IGNORED_INBOUND_AUDIT_RETENTION_DAYS: process.env.IGNORED_INBOUND_AUDIT_RETENTION_DAYS || 14,
