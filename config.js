...
module.exports = {
  ...
  INBOUND_MESSAGE_MAX_AGE_MINUTES: process.env.INBOUND_MESSAGE_MAX_AGE_MINUTES || 120,
  INBOUND_MESSAGE_DEDUP_TTL_SECONDS: process.env.INBOUND_MESSAGE_DEDUP_TTL_SECONDS || 21600,
