...
controller.get('/', validateRequest(IndexClientsRequest), async (req: Request, res: Response) => {
  try {
...
controller.post('/', validateRequest(StoreClientRequest), async (req: Request, res: Response) => {
  try {
